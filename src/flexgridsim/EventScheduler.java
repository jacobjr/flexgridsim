	...
	public void updateDeadlineEvent(DeadlineEvent oldEvent, DeadlineEvent newEvent) {
		...
		for (Event e : eventQueue) {
			if (e instanceof DeadlineEvent){
				if (((DeadlineEvent) e).getBatch().getSource() == oldEvent.getBatch().getSource()
						&& ((DeadlineEvent) e).getBatch().getDestination() == oldEvent.getBatch().getDestination()){
					eq = e;
					break;
				}
			}
...
//			if (!this.eventQueue.remove(oldEvent)) {
//				System.out.println("tempo " + oldEvent.getTime() +" nao tinha " + oldEvent.getBatch().getSource() + "-" + oldEvent.getBatch().getDestination() +" oldID=" + oldEvent.getID()+" newID=" + newEvent.getID());
//			} else {
//				System.out.println("tempo " + oldEvent.getTime() +" tinha " + oldEvent.getBatch().getSource() + "-" + oldEvent.getBatch().getDestination()+" oldID=" + oldEvent.getID()+" newID=" + newEvent.getID());
//			}
//			this.addEvent(newEvent);
//		}
